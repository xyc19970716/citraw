...
public:
    ...
    void setupUi(QWidget *ConfigureGeneral)
    {
        ...
        region_combobox->addItem(QString());
        region_combobox->addItem(QStringLiteral("JPN"));
        region_combobox->addItem(QStringLiteral("USA"));
        region_combobox->addItem(QStringLiteral("EUR"));
        region_combobox->addItem(QStringLiteral("AUS"));
        region_combobox->addItem(QStringLiteral("CHN"));
        region_combobox->addItem(QStringLiteral("KOR"));
        region_combobox->addItem(QStringLiteral("TWN"));
    ...
    void retranslateUi(QWidget *ConfigureGeneral)
    {
        ...
        toggle_deepscan->setText(QApplication::translate("ConfigureGeneral", "Search sub-directories for games", 0));
        ...
        region_combobox->setItemText(0, QApplication::translate("ConfigureGeneral", "Auto-select", 0));
