...
#include "../../../../../citra/src/citra_qt/debugger/profiler.h"
...
const QMetaObject MicroProfileDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MicroProfileDialog.data,
      qt_meta_data_MicroProfileDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MicroProfileDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MicroProfileDialog.stringdata0))
        return static_cast<void*>(const_cast< MicroProfileDialog*>(this));
